        ...
        >
          ...
          <div>
            <div className="feature-card" style={{ marginBottom: '24px' }}>
              <h3 className="h3" style={{ marginBottom: '20px' }}>Cybersecurity Skills</h3>
            ...
            <div className="feature-card" style={{ marginBottom: '24px' }}>
              <h3 className="h3" style={{ marginBottom: '20px' }}>Networking Expertise</h3>
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px' }}>
            ...
            <div className="feature-card">
              <h3 className="h3" style={{ marginBottom: '20px' }}>Tools & Technologies</h3>
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px' }}>
                {skillsData.tools.slice(0, 8).map((tool, index) => (
                  <span
                    key={index}
                    style={{
                      padding: '8px 16px',
